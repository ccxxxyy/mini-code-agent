...
[![Tests](https://img.shields.io/badge/tests-559%20passed-brightgreen)]()
...
```bash
uv sync --extra dev
uv run pytest tests/           # 559 tests
uv run ruff check src/ tests/  # lint
uv run ruff format src/ tests/ # format
```

See [docs/tasks.md](docs/tasks.md) for the full development history (P1–P48, 48 phases).
